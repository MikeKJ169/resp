...
class FeatureBox(models.Model):
    ...
    title = models.CharField(max_length=200, help_text='The title of the feature box. This will appear in the orange bar of the featurebox.') 
    ...
    picture = models.FileField(upload_to='smartpage_pics', blank=True, null=True, help_text='A picture for the feature box. This will override the text and be resized to fill up the whole of the box.') 
    class Meta:
